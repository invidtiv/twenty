...
export const buildMessageChannelMessageAssociationStandardFlatFieldMetadatas =
  ...
  > => ({
    ...
    isSpam: createStandardFieldFlatMetadata({
      objectName,
      workspaceId,
      context: {
        fieldName: 'isSpam',
        type: FieldMetadataType.BOOLEAN,
        label: i18nLabel(msg`Spam`),
        description: i18nLabel(msg`Message was classified as spam`),
    ...
    isImportant: createStandardFieldFlatMetadata({
      objectName,
      workspaceId,
      context: {
        fieldName: 'isImportant',
        type: FieldMetadataType.BOOLEAN,
        label: i18nLabel(msg`Important`),
        description: i18nLabel(msg`Message was classified as important`),
        icon: 'IconStar',
        isNullable: false,
        isUIReadOnly: true,
        defaultValue: false,
