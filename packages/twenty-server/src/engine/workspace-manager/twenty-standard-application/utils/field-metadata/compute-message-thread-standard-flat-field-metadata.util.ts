...
>): Record<AllStandardObjectFieldName<'messageThread'>, FlatFieldMetadata> => ({
  ...
  messageFrom: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Sender of the latest message in the thread`),
      icon: 'IconAt',
      isNullable: true,
      isUIReadOnly: true,
    },
  ...
  messageTo: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'messageTo',
      ...
      description: i18nLabel(
        msg`Recipients of the latest message in the thread`,
      ),
      icon: 'IconAt',
      isNullable: true,
      isUIReadOnly: true,
