...
import { AddMessageThreadFromCommand } from 'src/database/commands/upgrade-version-command/2-9/2-9-workspace-command-1799000030000-add-message-thread-from.command';
...
@Module({
  ...
  providers: [MigrateAiModelPreferencesCommand, AddMessageThreadFromCommand],
})
