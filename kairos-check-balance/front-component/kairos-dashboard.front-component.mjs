...
// kairos-check-balance/front-component/kairos-dashboard.front-component.tsx
...
var plural = (count, word) => count + " " + (count === 1 ? word : word + "s");
var monthShort = (monthKey) => {
  const [year, month] = monthKey.split("-").map(Number);
  return new Intl.DateTimeFormat("en-GB", {
    month: "short",
    timeZone: "UTC"
...
var formatDay = (iso) => new Intl.DateTimeFormat("en-GB", {
  weekday: "short",
  day: "numeric",
  month: "short",
  timeZone: TIME_ZONE
}).format(new Date(iso));
var loadBalance = async () => {
...
var KairosDashboard = () => {
  ...
  const flatEvents = months.flatMap(
    (month) => month.events.map((event) => ({ ...event, month: month.month }))
  );
  const upcoming = flatEvents.filter((event) => event.status !== "COMPLETED").sort((a, b) => a.startsAt.localeCompare(b.startsAt));
  const completed = flatEvents.filter((event) => event.status === "COMPLETED").sort((a, b) => b.startsAt.localeCompare(a.startsAt));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 18, fontWeight: 700 }, children: "Kairos Dashboard" }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: 4, fontSize: 12, color: MUTED }, children: "Check-in earnings: 25\u20AC before 21:00, 30\u20AC from 21:00 (Lisbon time). Scheduled check-ins count." })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "button",
                    {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { overflow: "auto", flex: 1, margin: 14 }, children: [
          loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { padding: 36, color: MUTED, fontSize: 13 }, children: "Loading dashboard\u2026" }),
          ...
          !loading && !error && balance && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "div",
              {
                style: {
                ...
                children: [
                  ...
                  {
                    label: "AVERAGE / CHECK",
                    value: balance.totalChecks > 0 ? Math.round(balance.totalAmount / balance.totalChecks * 100) / 100 + "\u20AC" : "\u2014",
                    sub: "per check-in",
                    accent: true
                  }
                ].map((card) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    style: {
                      ...cardStyle,
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 24, fontWeight: 750, marginTop: 5 }, children: card.value }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 11, color: FAINT, marginTop: 3 }, children: card.sub })
                    ]
                  },
                  card.label
                ))
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, fontWeight: 700 }, children: "Monthly earnings" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 11, color: FAINT, marginTop: 2 }, children: "Stacked: 25\u20AC checks (green) + 30\u20AC checks (amber)" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          "svg",
                          {
                            ...
                            children: [
                              ...
                              chartMonths.map((month, index) => {
                                ...
                                const beforeHeight = month.before21 * 25 / maxMonthAmount * plotHeight;
                                ...
                                return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    "text",
                                    {
                                      ...
                                      fontSize: 10.5,
                                      fill: FAINT,
                                      children: monthShort(month.month)
                                    }
                                  )
                                ] }, month.month);
                              })
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, fontWeight: 700 }, children: "Before / after 21:00" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 11, color: FAINT, marginTop: 2 }, children: "Share of earned amount" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          "div",
                          {
                            style: {
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    "circle",
                                    {
                                      ...
                                      stroke: GREEN,
                                      strokeWidth: 24,
                                      strokeDasharray: donutCircumference * beforeFraction + " " + donutCircumference,
                                      strokeDashoffset: -donutCircumference * 0.25,
                                      transform: "rotate(-90 90 90)"
                                    }
                                  ),
                                  beforeFraction < 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    "circle",
                                    {
                                      cx: 90,
                                      cy: 90,
                                      ...
                                      stroke: AMBER,
                                      strokeWidth: 24,
                                      strokeDasharray: donutCircumference * (1 - beforeFraction) + " " + donutCircumference,
                                      strokeDashoffset: -donutCircumference * (0.25 + beforeFraction),
                                      transform: "rotate(-90 90 90)"
                                    }
                                  ),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: FAINT }, children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    "span",
                                    {
                                      style: {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, fontWeight: 700 }, children: "Upcoming check-ins" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 11, color: FAINT, marginTop: 2 }, children: [
                          "Scheduled \xB7 ",
                          plural(upcoming.length, "check")
                        ] }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          "div",
                          {
                            ...
                            children: [
                              upcoming.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { padding: 18, color: MUTED, fontSize: 12 }, children: "No upcoming check-ins." }),
                              upcoming.map((event) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                "div",
                                {
                                  style: {
                                    display: "flex",
                                        ...
                                        children: [
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                            "div",
                                            {
                                              ...
                                              children: formatDay(event.startsAt)
                                            }
                                          ),
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { minWidth: 0 }, children: [
                                            ...
                                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 10.5, color: FAINT }, children: [
                                              event.localTime,
                                              " Lisbon",
                                              event.propertyName ? " \xB7 " + event.propertyName : ""
                                            ] })
                                          ] })
                                        ]
                                      }
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                      "span",
                                      {
                                        style: {
                                          flexShrink: 0,
                                          fontWeight: 750,
                                          color: event.amount >= 30 ? AMBER : GREEN
                                        },
                                        children: [
                                          event.amount,
                                          "\u20AC"
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, fontWeight: 700 }, children: "Completed check-ins" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 11, color: FAINT, marginTop: 2 }, children: [
                          "Most recent first \xB7 ",
                          plural(completed.length, "check")
                        ] }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          "div",
                          {
                            ...
                            children: [
                              completed.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { padding: 18, color: MUTED, fontSize: 12 }, children: "No completed check-ins yet." }),
                              completed.map((event) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                "div",
                                {
                                  style: {
                                    display: "flex",
...
var kairos_dashboard_front_component_default = (container) => {
  (0, import_client.createRoot)(container).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(KairosDashboard, {}));
};
export {
  kairos_dashboard_front_component_default as default
};
